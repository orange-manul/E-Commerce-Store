            ...
            <div class="table-responsive text-nowrap">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <br>
                        <a href="{{ route('edit.product_img',$product->id), }}" class="btn btn-primary mt-3">Update Image</a>
                        </td>
                        <td>{{ $product->price }}</td>
                        <td><a href="{{ route('edit.product', $product->id) }}" class="btn btn-primary">Edit</a>
                            <a href="{{ route('delete.product', $product->id) }}" class="btn btn-danger">Delete</a></td>
                    </tr>
                    @endforeach
                    </tbody>
                </table>
