                ...
                <div class="col-sm-12">
                    <div class="custom_menu">
                        ...
                        @auth()
                            ...
                            @endauth
                                @role('admin')
                                <li><a href="{{ route('admin.dashboard') }}">Admin panel
                                    </a></li>
                                @endrole
                        </ul>
                    </div>
        ...
        <div class="container">
            <div class="containt_main">
                ...
                <span class="toggle_icon" onclick="openNav()"><img
                        src="{{ asset('home/images/toggle-icon.png') }}" alt=""></span>
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        @foreach($categories as $category)
                            <a class="dropdown-item" href="{{ route('category', [$category->id, $category->slug] ) }}">
